...
public class JpaDemo {
    ...
    public static void main(String[] args) {
        ...
        Set<Department> empDepts=foundEmployee.getDepartments();
        System.out.println("****departments of employee");
        empDepts.stream().forEach(dept->{
            System.out.println(dept.getId()+"-"+dept.getName());
        });


        Department foundDept=demo.em.find(Department.class,deptId);
        System.out.println("***displaying fetched dept="+foundDept.getId()+ foundDept.getName());
        Set<Employee>employees=foundDept.getEmployees();
        System.out.println("***displaying fetched employees from department");
        employees.stream().forEach(emp->demo.displayEmployee(emp));
